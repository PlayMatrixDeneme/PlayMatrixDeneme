...
const GAME_RESULT_CODES = Object.freeze({
  ...
  CHESS_TIMEOUT_WIN: 'chess_timeout_win',
  ...
  PISTI_NORMAL_WIN: 'pisti_normal_win',
  PISTI_DRAW: 'pisti_draw',
  PISTI_DISCONNECT_WIN: 'pisti_disconnect_win',
  PISTI_LEAVE_WIN: 'pisti_leave_win',
  PISTI_ABANDONED: 'pisti_abandoned',
  PISTI_WAITING_CANCELLED: 'pisti_waiting_cancelled'
});
...
const CHESS_INITIAL_CLOCK_MS = Math.max(60 * 1000, Number(process.env.CHESS_INITIAL_CLOCK_MS || 10 * 60 * 1000));
const CHESS_INCREMENT_MS = Math.max(0, Number(process.env.CHESS_INCREMENT_MS || 2 * 1000));
