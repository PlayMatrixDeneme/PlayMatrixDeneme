(function () {
  ...
  const VERSION = 'phase10-11-runtime-fix-20260426h';
  ...
  const FALLBACK_GAMES = [
    { name: 'Crash', category: 'online', access: 'auth', url: '/Online Oyunlar/Crash', icon: 'fa-arrow-trend-up', desc: 'Refleks ve zamanlama odaklı online multiplier oyunu.', tags: ['Canlı Oyun', 'Rekabet', 'Hızlı Tur'] },
    { name: 'Satranç', category: 'online', access: 'auth', url: '/Online Oyunlar/Satranc', icon: 'fa-chess', desc: 'Modern arayüzlü online satranç arenası.', tags: ['PvP', 'Strateji', 'Arena'] },
    { name: 'Pişti', category: 'online', access: 'auth', url: '/Online Oyunlar/Pisti', icon: 'fa-layer-group', desc: 'Gerçek oyuncularla online pişti masaları.', tags: ['Kart', 'Online', 'Klasik'] },
    { name: 'Pattern Master', category: 'classic', access: 'free', url: '/Klasik Oyunlar/PatternMaster', icon: 'fa-shapes', desc: 'Dikkat ve görsel hafıza oyunu.', tags: ['Ücretsiz', 'Zeka', 'Refleks'] },
    { name: 'Space Pro', category: 'classic', access: 'free', url: '/Klasik Oyunlar/SpacePro', icon: 'fa-user-astronaut', desc: 'Hızlı klasik arcade uzay oyunu.', tags: ['Arcade', 'Retro', 'Ücretsiz'] },
    { name: 'Snake Pro', category: 'classic', access: 'free', url: '/Klasik Oyunlar/SnakePro', icon: 'fa-wave-square', desc: 'Retro hisli akıcı snake oyunu.', tags: ['Retro', 'Arcade', 'Ücretsiz'] }
  ];
  ...
  function installClickGuards() {
    ...
    document.addEventListener('click', (event) => {
      ...
      const onlineTrigger = event.target.closest?.('a[href*="Online Oyunlar"], [data-requires-auth="true"], .game-card');
      if (onlineTrigger) {
