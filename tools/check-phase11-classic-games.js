...
mustContain('Klasik Oyunlar/PatternMaster.html', '../public/js/games/classic/pattern-master/index.js', 'PatternMaster kalıcı modül yolu');
mustContain('Klasik Oyunlar/SnakePro.html', '../public/js/games/classic/snake-pro/index.js', 'SnakePro kalıcı modül yolu');
mustContain('Klasik Oyunlar/SpacePro.html', '../public/js/games/classic/space-pro/index.js', 'SpacePro kalıcı modül yolu');

walk('Klasik Oyunlar').forEach((rel) => {
...
if (pkg.scripts?.['check:phase11-classic-games'] !== 'node tools/check-phase11-classic-games.js') {
...
console.log('check:phase11-classic-games OK');
