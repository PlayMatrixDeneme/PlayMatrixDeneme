...
(async () => {
  ...
  if (!frontendSource.includes('GENERATED_FROM_BACKEND_PROGRESSION_POLICY')) fail('Frontend progression policy backend üretimli değil.');
  ...
  if (typeof frontend.formatXpExact !== 'function' || typeof frontend.compactXpExact !== 'function') fail('Frontend exact XP formatlayıcıları eksik.');
