...
mustContain('online-games/pisti.js', 'function ensureRealtimeShell', 'Pişti realtime shell helper');
mustContain('online-games/chess.js', 'function ensureRealtimeShell', 'Satranç realtime shell helper');
mustContain('online-games/pisti.js', 'function showRealtimeToast', 'Pişti toast helper');
mustContain('online-games/chess.js', 'function showRealtimeToast', 'Satranç toast helper');
mustContain('online-games/pisti.js', 'function playSfx', 'Pişti SFX helper');
mustContain('online-games/chess.js', 'function playSfx', 'Satranç SFX helper');
mustContain('online-games/pisti.js', 'function showRealtimeInviteModal', 'Pişti invite modal fallback');
