...
console.log('Security Phase 0 kontrolü başarılı. FIREBASE_KEY standardı, secret dosya koruması, hardcoded runtime fallback ve Firebase memory fallback kapalı.');
process.exit(0);
